...
const sideQuests = [
    ...
    "Put your phone away and enjoy some quiet time.",
    ...
    "Read a few pages of a book you like.",
    "Spend some time with a pet.",
    "Look out the window and notice what is happening outside.",
    "Go outside and look at the sky.",
    "Try to balance a random object on your head for 10 seconds.",
    "Pretend you are the main character in a movie for five minutes.",
    "Make up a ridiculous superhero name for yourself.",
